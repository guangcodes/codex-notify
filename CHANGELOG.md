...
发布说明：[GitHub Release v0.1.3](https://github.com/guangcodes/codex-notify/releases/tag/v0.1.3)；
完整差异：[v0.1.2...v0.1.3](https://github.com/guangcodes/codex-notify/compare/v0.1.2...v0.1.3)。
